...
namespace Image
{
    ...
    Simple01::Simple01(const std::string &filename)
    : Base()
    {
        load(filename);
    }
    ...
    Simple01::Simple01(Simple01 &&rhs)
    : Base(std::move(rhs))
    {
    }
    ...
    Simple01 &Simple01::operator=(const Simple01 &rhs)
    {
        if (this != &rhs)
            Base::operator=(rhs);
    ...
    Simple01 &Simple01::operator=(Simple01 &&rhs)
    {
        if (this != &rhs)
    ...
    Simple01::RGBA Simple01::pixel(const int64_t x, const int64_t y) const
    {
    ...
    bool Simple01::setPixel(const int64_t x, const int64_t y, const RGBA color)
    {
        if (T::inRange(x, 0, width()) && T::inRange(y, 0, height()))
        {
    ...
    bool Simple01::setLine(const int64_t x1, const int64_t y1, const int64_t x2, const int64_t y2,
                         const RGBA color)
    {
    ...
    bool Simple01::setTriangle(const int64_t x1, const int64_t y1, const int64_t x2,
    ...
    bool Simple01::setRectangle(const int64_t x1, const int64_t y1, const int64_t x2,
    ...
    bool Simple01::setCircle(const int64_t x, const int64_t y, const int64_t radius,
                             const RGBA color, const bool fill)
    {
    ...
    bool Simple01::save(const std::string &filename) const
    {
    ...
    bool Simple01::load(const std::string &filename)
    {
    ...
    bool Simple01::identify(const std::string &filename)
    {
        if (std::ifstream ifile(filename); ifile.is_open() && ifile.good())
        {
            const size_t size = ifile.seekg(0, std::ios::end).tellg();
    ...
    std::string Simple01::encodeRLE(const Pixels &pixels) const
    {
    ...
    Simple01::Pixels Simple01::decodeRLE(const std::string &data) const
    {
